...
window.onload = function(){
  ...
  class MEME_CHAT{
    ...
    create_join_form(){
      ...
      join_button.innerHTML = ' Присоединиться <i class="fas fa-sign-in-alt"></i>'
      ...
      join_input.placeholder = 'Введите имя...'
    ...
    create_chat(){
      ...
      chat_input.placeholder = `${parent.get_name()}. Написать в чат...`
      ...
      chat_logout.textContent = `${parent.get_name()} • выйти`
